...
<html>
    ...
    <body>
        ...
        <form action="Create" method="POST" style="width: 700px; margin: 0 auto">
            ...
            <div class="text-center text-muted">
                Question:  <input style="width: 400px" type="text" name="txtQuestion" value="${param.txtQuestion}"/>
            </div>
            <br>
                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><input type="text" name="txtAnsA" value="${param.txtAnsA}" style="width: 550px"/></td>
                        </tr>
                        <tr>
                            <td width="8%">
                                <input type="radio" name="rdAnsCorrect" value="1" />
                            </td>
                            <td><input type="text" name="txtAnsB" value="${param.txtAnsB}" style="width: 550px"/></td>
                        </tr>
                        <tr>
                            <td width="8%">
                                <input type="radio" name="rdAnsCorrect" value="2" />
                            </td>
                            <td><input type="text" name="txtAnsC" value="${param.txtAnsC}" style="width: 550px"/></td>
                        </tr>
                        <tr>
                            <td width="8%">
                                <input type="radio" name="rdAnsCorrect" value="3" />
                            </td>
                            <td><input type="text" name="txtAnsD" value="${param.txtAnsD}" style="width: 550px"/></td>
                        </tr>
            ...
            <div class="text-center text-muted">
                <input class="btn btn-success" style="padding:5px 40px; margin-bottom: 30px"type="submit" name="" value="Create"/>
            </div>
